...
class ContractorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contractor" do
    assert_difference('Contractor.count') do
      post contractors_url, params: { contractor: { address: @contractor.address, email: @contractor.email, phone: @contractor.phone, title: @contractor.title } }
    end
  ...
  test "should update contractor" do
    patch contractor_url(@contractor), params: { contractor: { address: @contractor.address, email: @contractor.email, phone: @contractor.phone, title: @contractor.title } }
