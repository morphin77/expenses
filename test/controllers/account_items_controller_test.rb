...
class AccountItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create account_item" do
    assert_difference('AccountItem.count') do
      post account_items_url, params: { account_item: { amount: @account_item.amount, contactor_id: @account_item.contactor_id, service: @account_item.service } }
    end
  ...
  test "should update account_item" do
    patch account_item_url(@account_item), params: { account_item: { amount: @account_item.amount, contactor_id: @account_item.contactor_id, service: @account_item.service } }
